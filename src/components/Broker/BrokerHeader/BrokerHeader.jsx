...
import {
  userSelect,
  applicationSelect,
} from "../../../store/slices/managerSelect";
import {
  emailSelect,
  groupSelect,
  dateSelect,
} from "../../../store/slices/sortBroker";
  ...
  return (
    <div className={s.header}>
      ...
      <div className={s.right}>
        <button
          className={
            managerSelect.users ? s.sortBtn + " " + s.activ : s.sortBtn
          }
          onClick={() => dispatch(userSelect())}
        >
          Users
        </button>
        <button
          className={
            managerSelect.application ? s.sortBtn + " " + s.activ : s.sortBtn
          }
          onClick={() => dispatch(applicationSelect())}
        >
          Заявки
        </button>
      </div>
