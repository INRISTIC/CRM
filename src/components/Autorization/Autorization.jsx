    ...
    <div className={s.mainBlock}>
      <div className={s.block}>
        <div className={s.select}>
          <button
            className={
              autorization.open ? s.selectBtn + " " + s.active : s.selectBtn
            }
            onClick={() => setAuto({ open: true, close: false })}
          >
            Вход
          </button>
          <button
            className={
              autorization.close ? s.selectBtn + " " + s.active : s.selectBtn
            }
            onClick={() => setAuto({ close: true, open: false })}
          >
            Заявка
          </button>
        </div>
